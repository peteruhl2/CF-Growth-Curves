%%% Sensitivity matrix and standard error for E faecalis model 2 (aerobic)
%%% model is
%%%
...
data = xlsread('/Users/peteruhl/OneDrive/Growth-Curves/Aerobic Growth/Efaecalis Aerobic.xlsx');
