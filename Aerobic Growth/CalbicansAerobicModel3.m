%%% C albicans aerobic growth, model #3
%%% model is
%%%
...
lb = zeros(length(p),1);
ub = [50; 20; 100; 5; 50; 50; 50; 100; 0.01];
...
% legend('C. albicans optical density', 'Fontsize', 18)
% exportgraphics(gcf,'cal_aer.pdf','ContentType','vector')
