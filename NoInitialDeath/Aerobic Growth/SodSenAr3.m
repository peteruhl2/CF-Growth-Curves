%%% Sensitivity matrix and standard error for S odorifera model 3 (aerobic)
%%% model is
%%%
...
data = xlsread('/Users/peteruhl/OneDrive/Growth-Curves/Aerobic Growth/Sodorifera Aerobic.xlsx');
...
% plot(tdata, ss_alpha, '.')
% plot(tdata, ss_b0)
legend('d\phi/dr','d\phi/dn','d\phi/dd','d\phi/d\gamma','d\phi/d\delta','d\phi/d\mu',...
