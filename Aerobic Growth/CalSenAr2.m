%%% Sensitivity matrix and standard error for C albicans model 2 (aerobic)
%%% model is
%%%
...
data = xlsread('/Users/peteruhl/OneDrive/Growth-Curves/Aerobic Growth/Calbicans Aerobic.xlsx');
...
M = [ss_r, ss_Ks, ss_d, ss_gamma, ss_delta, ss_mu, ss_b0];
...
% plot(tdata, ss_alpha, '.')
% plot(tdata, ss_b0)
legend('d\phi/dr','d\phi/dd','d\phi/d\gamma','d\phi/d\delta','d\phi/d\mu',...
...
plot(tdata, ss_Ks)
plot(tdata, ss_b0,'<')
legend('d\phi/dK_s','d\phi/dx_0','Location','northeast','Fontsize',12)
xlabel('Time (days)','Fontsize',18)
