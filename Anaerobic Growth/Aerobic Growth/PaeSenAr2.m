%%% Sensitivity matrix and standard error for P aeruginosa model 2 (aerobic)
%%% model is
%%%
...
data = xlsread('/Users/peteruhl/OneDrive/Growth-Curves/Aerobic Growth/Paeruginosa Aerobic.xlsx');
...
plot(tdata, ss_alpha, '.')
% plot(tdata, ss_b0)
legend('dP/dr','dP/dd','dP/d\gamma','dP/d\delta','dP/d\mu',...
